  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <input
        ...
        className="text-primary text-base md:text-xs w-1/2 md:w-4/5 p-3 md:p-1 mt-10 mb-6 bg-secondary border-double border-b-4 border-b-primary border-r-4 border-r-primary rounded outline-none"
        onChange={(e) => setInput(e.target.value)}
      ></input>
      <input
        type="number"
        placeholder="Enter size (default is 150px)"
        className="text-primary text-base md:text-xs w-1/2 md:w-4/5 p-3 md:p-1 mt-4 mb-6 bg-secondary border-double border-b-4 border-b-primary border-r-4 border-r-primary rounded outline-none"
